...
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE}
## AUS GLONAF
directory_files_aus_glonaf = list.files(here("13.  bias assessment results", "aus_glonaf-native-filtered"))
file_link_aus_glonaf = here("13.  bias assessment results", "aus_glonaf-native-filtered", directory_files_aus_glonaf[grepl("periods_output", directory_files_aus_glonaf)])
...
## ZAF
directory_files_zaf = list.files(here("13.  bias assessment results", "zaf-native-filtered"))
file_link_zaf = here("13.  bias assessment results", "zaf-native-filtered", directory_files_zaf[grepl("periods_output", directory_files_zaf)])
...
## JPN
directory_files_jpn = list.files(here("13.  bias assessment results", "jpn-native-filtered"))
file_link_jpn = here("13.  bias assessment results", "jpn-native-filtered", directory_files_jpn[grepl("periods_output", directory_files_jpn)])
...
## MDG
directory_files_mdg = list.files(here("13.  bias assessment results", "mdg-native-filtered"))
file_link_mdg = here("13.  bias assessment results", "mdg-native-filtered", directory_files_mdg[grepl("periods_output", directory_files_mdg)])
...
## IRL
directory_files_irl = list.files(here("13.  bias assessment results", "irl-nir-native-filtered"))
file_link_irl = here("13.  bias assessment results", "irl-nir-native-filtered", directory_files_irl[grepl("periods_output", directory_files_irl)])
...
## NZL GLONAF
directory_files_nzl_glonaf = list.files(here("13.  bias assessment results", "nzl-Glonaf-native-filtered"))
file_link_nzl_glonaf = here("13.  bias assessment results", "nzl-Glonaf-native-filtered", directory_files_nzl_glonaf[grepl("periods_output", directory_files_nzl_glonaf)])
...
***NOT RUN. PERIODS FILES MISSING***
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE, eval=FALSE}
## GBR
directory_files_gbr = list.files(here("13.  bias assessment results", "gbr-native-filtered"))
file_link_gbr = here("13.  bias assessment results", "gbr-native-filtered", directory_files_gbr[grepl("periods_output", directory_files_gbr)])
...
## USA
directory_files_usa = list.files(here("13.  bias assessment results", "usa-native-filtered"))
file_link_usa = here("13.  bias assessment results", "usa-native-filtered", directory_files_usa[grepl("periods_output", directory_files_usa)])
...
library(dplyr)
## AUS GLONAF
file_link_aus_glonaf = here("13.  bias assessment results", "aus_glonaf-native-filtered", directory_files_aus_glonaf[grepl("assessRecordNumber_output", directory_files_aus_glonaf)])
...
## IRL
file_link_irl = here("13.  bias assessment results", "irl-nir-native-filtered", directory_files_irl[grepl("assessRecordNumber_output", directory_files_irl)])
...
## JPN
file_link_jpn = here("13.  bias assessment results", "jpn-native-filtered", directory_files_jpn[grepl("assessRecordNumber_output", directory_files_jpn)])
...
## MDG
file_link_mdg = here("13.  bias assessment results", "mdg-native-filtered", directory_files_mdg[grepl("assessRecordNumber_output", directory_files_mdg)])
...
## NZL GLONAF
file_link_nzl_glonaf = here("13.  bias assessment results", "nzl-Glonaf-native-filtered", directory_files_nzl_glonaf[grepl("assessRecordNumber_output", directory_files_nzl_glonaf)])
...
## ZAF
file_link_zaf = here("13.  bias assessment results", "zaf-native-filtered", directory_files_zaf[grepl("assessRecordNumber_output", directory_files_zaf)])
...
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE, eval=FALSE}
## GBR
file_link_gbr = here("13.  bias assessment results", "gbr-native-filtered", directory_files_gbr[grepl("assessRecordNumber_output", directory_files_gbr)])
...
## USA
file_link_usa = here("13.  bias assessment results", "usa-native-filtered", directory_files_usa[grepl("assessRecordNumber_output", directory_files_usa)])
...
### by species 
file_link_gbr_by_species = here("13.  bias assessment results", "gbr-native-filtered", directory_files_gbr[grepl("assessRecordNumber_output", directory_files_gbr)])

file_link_gbr_by_species = file_link_gbr_by_species[grepl("species", file_link_gbr_by_species)]
assessRecordNumber_gbr_by_species = read.csv(file = file_link_gbr) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
## USA
file_link_usa_by_species = here("13.  bias assessment results", "usa-native-filtered", directory_files_usa[grepl("assessRecordNumber_output", directory_files_usa)])
...
grid.arrange(record_number_aus_glonaf, record_number_zaf, ncol = 2)
```
...
grid.arrange(record_number_usa, record_number_gbr, ncol = 2)
```
...
file_link_aus_glonaf = file_link_aus_glonaf[grepl("species", file_link_aus_glonaf)]
assessRecordNumber_aus_glonaf_by_species = read.csv(file = file_link_aus_glonaf) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
file_link_irl = file_link_irl[grepl("species", file_link_irl)]
assessRecordNumber_irl_by_species = read.csv(file = file_link_irl) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
file_link_jpn = file_link_jpn[grepl("species", file_link_jpn)]
assessRecordNumber_jpn_by_species = read.csv(file = file_link_jpn) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
file_link_mdg = file_link_mdg[grepl("species", file_link_mdg)]
assessRecordNumber_mdg_by_species = read.csv(file = file_link_mdg) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
file_link_nzl_glonaf = file_link_nzl_glonaf[grepl("species", file_link_nzl_glonaf)]
assessRecordNumber_nzl_glonaf_by_species = read.csv(file = file_link_nzl_glonaf) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
file_link_zaf = file_link_zaf[grepl("species", file_link_zaf)]
assessRecordNumber_zaf_by_species = read.csv(file = file_link_zaf) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
file_link_usa = file_link_usa[grepl("species", file_link_usa)]
assessRecordNumber_usa_by_species = read.csv(file = file_link_usa) |>
  group_by(group) |>
  summarise(Period = Period, 
            val = val / max(val, na.rm = T)) 
...
library(ggplot2)
n_species_aus_glonaf = assessRecordNumber_aus_glonaf |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
n_species_irl = assessRecordNumber_irl |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
n_species_jpn = assessRecordNumber_jpn |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
n_species_mdg = assessRecordNumber_mdg |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
n_species_nzl_glonaf = assessRecordNumber_nzl_glonaf |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
n_species_zaf = assessRecordNumber_zaf |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
grid.arrange(n_species_aus_glonaf, n_species_zaf, ncol = 2)
```
...
***NOT RUN. PERIODS FILES MISSING***
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE, eval=FALSE}
n_species_gbr = assessRecordNumber_gbr |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
n_species_usa = assessRecordNumber_usa |>
  dplyr::filter(!is.na(val)) |>
  ggplot(mapping = aes(x = Period, y = val, color = Taxonomic_Group)) +
  geom_point( ) + geom_line() + 
  theme_bw() + labs(y = "Number of records recorded", 
...
grid.arrange(n_species_usa, n_species_gbr, ncol = 2)
```
...
# AUS GLONAF
fit_records_aus_glonaf = aov(val ~ Taxonomic_Group , data = assessRecordNumber_aus_glonaf)
...
x = table(assessRecordNumber_aus_glonaf$Taxonomic_Group)
...
# IRL
fit_records_irl = aov(val ~ Taxonomic_Group , data = assessRecordNumber_irl)
...
x = table(assessRecordNumber_irl$Taxonomic_Group) 
...
# JPN
fit_records_jpn = aov(val ~ Taxonomic_Group , data = assessRecordNumber_jpn)
...
x = table(assessRecordNumber_jpn$Taxonomic_Group) 
...
x = table(assessRecordNumber_mdg$Taxonomic_Group) 
...
# NZL GLONAF
fit_records_nzl_glonaf = aov(val ~ Taxonomic_Group , data = assessRecordNumber_nzl_glonaf)
...
x = table(assessRecordNumber_nzl_glonaf$Taxonomic_Group) 
...
# ZAF
fit_records_zaf = aov(val ~ Taxonomic_Group , data = assessRecordNumber_zaf)
...
x = table(assessRecordNumber_zaf$Taxonomic_Group) 
...
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE, eval=FALSE}
# GBR
fit_records_gbr = aov(val ~ Taxonomic_Group , data = assessRecordNumber_gbr)
...
x = table(assessRecordNumber_gbr$Taxonomic_Group) 
...
# USA
fit_records_usa = aov(val ~ Taxonomic_Group , data = assessRecordNumber_usa)
...
x = table(assessRecordNumber_usa$Taxonomic_Group) 
...
tukey_species_usa$Taxonomic_Group = tukey_species_usa$Taxonomic_Group |> as.data.frame()
species_differences_usa = tukey_species_usa$Taxonomic_Group[!(tukey_species_usa$Taxonomic_Group[, "p adj"] > 0.05) , ] |>
   as.data.frame() |>  
  dplyr::arrange(desc(abs(diff))) |>
  dplyr::rename(difference = diff)
...
dplyr::tibble(
  ...
  `pairs of families compared` = c(
    assessRecordNumber_aus_glonaf$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_gbr$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_irl$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_jpn$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_mdg$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_nzl_glonaf$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_usa$Taxonomic_Group |> unique() |> length() |> choose(2),
    assessRecordNumber_zaf$Taxonomic_Group |> unique() |> length() |> choose(2)),
  ...
  `ANOVA p.value` = c(p.value_aus_glonaf, 
                      p.value_gbr, 
                      p.value_irl, p.value_jpn, p.value_mdg, p.value_nzl_glonaf,
                      p.value_usa, 
                      p.value_zaf)) |> 
...
## tukey test
tukey_species_gbr_by_species = TukeyHSD(fit_records_gbr_by_species, "Taxonomic_Group")

x = table(assessRecordNumber_gbr_by_species$Taxonomic_Group) 
species_differences_gbr2_by_species = tukey_species_gbr_by_species$Taxonomic_Group |> as.data.frame() 

for (i in length(x):1) {
  species_differences_gbr2_by_species[grepl(x = species_differences_gbr2_by_species |> row.names(), 
                                        pattern = names(x)[i]), "count"] = paste(species_differences_gbr2_by_species[grepl(x = species_differences_gbr2_by_species |>
                                                                                                                         row.names(), pattern = names(x)[i]), "count"], x[i], sep = ", ")
} 

species_differences_gbr2_by_species$count = gsub("NA, ", "", species_differences_gbr2_by_species$count)

species_differences_gbr_by_species = tukey_species_gbr_by_species$Taxonomic_Group[!(tukey_species_gbr_by_species$Taxonomic_Group[, "p adj"] > 0.05) , ] |> as.data.frame() |>  
  dplyr::arrange(desc(abs(diff))) |>
  dplyr::rename(difference = diff)

species_differences_gbr_by_species = cbind(data.frame(do.call(rbind, (rownames(species_differences_gbr_by_species) |> strsplit(split = "-")))),
      species_differences_gbr_by_species)

## groups with bias
biased_groups_gbr = rownames(species_differences_gbr_by_species) |> strsplit(split = "-") |>
  unlist()
...
## tukey test
tukey_species_usa_by_species = TukeyHSD(fit_records_usa_by_species, "Taxonomic_Group")

x = table(assessRecordNumber_usa_by_species$Taxonomic_Group) 
species_differences_usa2_by_species = tukey_species_usa_by_species$Taxonomic_Group |> as.data.frame() 

for (i in length(x):1) {
  species_differences_usa2_by_species[grepl(x = species_differences_usa2_by_species |> row.names(), 
                                        pattern = names(x)[i]), "count"] = paste(species_differences_usa2_by_species[grepl(x = species_differences_usa2_by_species |>
                                                                                                                         row.names(), pattern = names(x)[i]), "count"], x[i], sep = ", ")
} 

species_differences_usa2_by_species$count = gsub("NA, ", "", species_differences_usa2_by_species$count)

species_differences_usa_by_species = tukey_species_usa_by_species$Taxonomic_Group[!(tukey_species_usa_by_species$Taxonomic_Group[, "p adj"] > 0.05) , ] |> as.data.frame() |>  
  dplyr::arrange(desc(abs(diff))) |>
  dplyr::rename(difference = diff)

species_differences_usa_by_species = cbind(data.frame(do.call(rbind, (rownames(species_differences_usa_by_species) |> strsplit(split = "-")))),
      species_differences_usa_by_species)

## groups with bias
biased_groups_usa = rownames(species_differences_usa_by_species) |> strsplit(split = "-") |>
  unlist()
```
...
dplyr::tibble(
  ...
  `ANOVA p.value` = c(p.value_aus_glonaf_by_species, 
                      # p.value_gbr_by_species,
                      p.value_irl_by_species, p.value_jpn_by_species, p.value_mdg_by_species, p.value_nzl_glonaf_by_species, 
                      # p.value_usa_by_species,
                      p.value_zaf_by_species)) |> 
  dplyr::mutate(`ANOVA p.value` = round(`ANOVA p.value`, 4)) |>
  knitr::kable()
```
...
aggregate_50 = function(region) {
  data_path = paste0(here(), "/13.  bias assessment results/", region, "-native-filtered/", region, "-native-filtered_periods_length_10_by_species_assessRecordNumber_output.csv")
...
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE}
regions = c("aus_glonaf", # "gbr",
            "irl-nir", "jpn", "mdg", "nzl-Glonaf", # "usa",
            "zaf")
...
# grid.arrange(usa, gbr, ncol = 2)
grid.arrange(irl, jpn, ncol = 2)
grid.arrange(mdg, nzl_glonaf, ncol = 2)
grid.arrange(aus_glonaf, zaf, ncol = 2)
```
...
# AnOVAtable
dplyr::tibble(
  range = c("AUS GLONAF", # "GBR",
            "IRL", "JPN", "MDG", "NZL GLONAF", # "USA",
            "ZAF"),
  ...
  `ANOVA p.value` = c(anova_aus_glonaf$p.value, # anova_gbr$p.value, 
                      anova_irl$p.value, anova_jpn$p.value, 
                      anova_mdg$p.value, anova_nzl_glonaf$p.value, # anova_usa$p.value,
                      anova_zaf$p.value)) |> 
  dplyr::mutate(`ANOVA p.value` = round(`ANOVA p.value`, 4)) |>
  knitr::kable()
```
...
# dplyr::full_join(species_differences_mdg |>
  # dplyr::rename(group_1 = X1, group_2 = X2, lower_conf_limit = lwr, upper_conf_limit = upr, `p value` = `p adj`) |> ## nrow(df) = 0
...
# aus_glonaf
sampling_intensity_slope_aus_glonaf = split.data.frame(assessRecordNumber_aus_glonaf_by_species, assessRecordNumber_aus_glonaf_by_species$Taxonomic_Group)  |>
...
# gbr (by species)
sampling_intensity_slope_gbr = split.data.frame(assessRecordNumber_gbr_by_species, assessRecordNumber_gbr_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
# irl
sampling_intensity_slope_irl = split.data.frame(assessRecordNumber_irl_by_species, assessRecordNumber_irl_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
# jpn
sampling_intensity_slope_jpn = split.data.frame(assessRecordNumber_jpn_by_species, assessRecordNumber_jpn_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
# mdg
sampling_intensity_slope_mdg = split.data.frame(assessRecordNumber_mdg_by_species, assessRecordNumber_mdg_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
# nzl_glonaf
sampling_intensity_slope_nzl_glonaf = split.data.frame(assessRecordNumber_nzl_glonaf_by_species, assessRecordNumber_nzl_glonaf_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
library(broom)
# usa
 sampling_intensity_slope_usa = split.data.frame(assessRecordNumber_usa_by_species, assessRecordNumber_usa_by_species$Taxonomic_Group)  |>
   purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
# zaf
sampling_intensity_slope_zaf = split.data.frame(assessRecordNumber_zaf_by_species, assessRecordNumber_zaf_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
...
dplyr::tibble(
  ...
  `families with increasing sampling` = c(
    increasing_coverage_aus_glonaf, # increasing_coverage_gbr, 
    increasing_coverage_irl,
    increasing_coverage_jpn, increasing_coverage_mdg, increasing_coverage_nzl_glonaf,
    # increasing_coverage_usa,
    increasing_coverage_zaf
  ),
  
  `families with decreasing sampling` = c(
    decreasing_coverage_aus_glonaf, # decreasing_coverage_gbr, 
    decreasing_coverage_irl,
    decreasing_coverage_jpn, decreasing_coverage_mdg, decreasing_coverage_nzl_glonaf,
    # decreasing_coverage_usa,
    decreasing_coverage_zaf
  ),
...
# irl
sampling_intensity_slope_irl_by_species = split.data.frame(assessRecordNumber_irl_by_species |> dplyr::rename(Period = Period), assessRecordNumber_irl_by_species$Taxonomic_Group)  |>
  purrr::map(~lm(val ~ 1 + Period, data = .x)) |>
  purrr::map_df(tidy) |>
  dplyr::filter(term == 'Period') |>
  dplyr::mutate(term = sort(assessRecordNumber_irl_by_species$Taxonomic_Group |> unique()), region = "irl") |>
...
dplyr::tibble(
  ...
  `species with increasing sampling` = c(
    increasing_coverage_aus_glonaf_by_species, # increasing_coverage_gbr_by_species, 
    increasing_coverage_irl_by_species,
    increasing_coverage_jpn_by_species, increasing_coverage_mdg_by_species, increasing_coverage_nzl_glonaf_by_species,
    # increasing_coverage_usa_by_species, 
    increasing_coverage_zaf_by_species
  ),
  
  `species with decreasing sampling` = c(
    decreasing_coverage_aus_glonaf_by_species, # decreasing_coverage_gbr_by_species,
    decreasing_coverage_irl_by_species,
    decreasing_coverage_jpn_by_species, decreasing_coverage_mdg_by_species, decreasing_coverage_nzl_glonaf_by_species,
    # decreasing_coverage_usa_by_species, 
    decreasing_coverage_zaf_by_species
  ),
...
library(dplyr)
## AUS GLONAF
file_link_aus_glonaf = here("13.  bias assessment results", "aus_glonaf-native-filtered", directory_files_aus_glonaf[grepl("assessSpeciesNumber_output", directory_files_aus_glonaf)])
...
# file_link_gbr = here("13.  bias assessment results", "gbr-native-filtered", directory_files_gbr[grepl("assessSpeciesNumber_output", directory_files_gbr)])
...
## IRL
file_link_irl = here("13.  bias assessment results", "irl-nir-native-filtered", directory_files_irl[grepl("assessSpeciesNumber_output", directory_files_irl)])
...
## JPN
file_link_jpn = here("13.  bias assessment results", "jpn-native-filtered", directory_files_jpn[grepl("assessSpeciesNumber_output", directory_files_jpn)])
...
## MDG
file_link_mdg = here("13.  bias assessment results", "mdg-native-filtered", directory_files_mdg[grepl("assessSpeciesNumber_output", directory_files_mdg)])
...
## NZL GLONAF
file_link_nzl_glonaf = here("13.  bias assessment results", "nzl-Glonaf-native-filtered", directory_files_nzl_glonaf[grepl("assessSpeciesNumber_output", directory_files_nzl_glonaf)])
...
## USA
# file_link_usa = here("13.  bias assessment results", "usa-native-filtered", directory_files_usa[grepl("assessSpeciesNumber_output", directory_files_usa)])
...
## ZAF
file_link_zaf = here("13.  bias assessment results", "zaf-native-filtered", directory_files_zaf[grepl("assessSpeciesNumber_output", directory_files_zaf)])
...
# grid.arrange(species_number_usa, species_number_gbr, ncol = 2)
...
grid.arrange(species_number_aus_glonaf, species_number_zaf, ncol = 2)
```
...
# species_differences_gbr = cbind(data.frame(do.call(rbind, (rownames(species_differences_gbr) |> strsplit(split = "-")))), species_differences_gbr)

## groups with bias
# biased_groups_gbr = rownames(species_differences_gbr) |> strsplit(split = "-") |> unlist()
...
# species_differences_usa = cbind(data.frame(do.call(rbind, (rownames(species_differences_usa) |> strsplit(split = "-")))), species_differences_usa)

## groups with bias
# biased_groups_usa = rownames(species_differences_usa) |> strsplit(split = "-") |> unlist()
...
dplyr::tibble(
  ...
  `ANOVA p.value` = c(p.value_aus_glonaf, # p.value_gbr, 
                      p.value_irl, p.value_jpn, p.value_mdg, p.value_nzl_glonaf, # p.value_usa,
                      p.value_zaf)) |> 
  dplyr::mutate(`ANOVA p.value` = round(`ANOVA p.value`, 4)) |>
  knitr::kable()
```
...
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE}
aggregate_50 = function(region) {
  data_path = paste0(here(), "/13.  bias assessment results/", region, "-native-filtered/", region, "-native-filtered_periods_length_10_by_species_assessSpeciesNumber_output.csv")
  data = readr::read_csv(data_path)
...
file_link_aus_glonaf = here("13.  bias assessment results", "aus_glonaf-native-filtered", directory_files_aus_glonaf[grepl("assessRarityBias_output", directory_files_aus_glonaf)])
...
# file_link_gbr = here("13.  bias assessment results", "gbr-native-filtered", directory_files_gbr[grepl("assessRarityBias_output", directory_files_gbr)])
...
file_link_irl = here("13.  bias assessment results", "irl-nir-native-filtered", directory_files_irl[grepl("assessRarityBias_output", directory_files_irl)])
...
file_link_jpn = here("13.  bias assessment results", "jpn-native-filtered", directory_files_jpn[grepl("assessRarityBias_output", directory_files_jpn)])
...
file_link_mdg = here("13.  bias assessment results", "mdg-native-filtered", directory_files_mdg[grepl("assessRarityBias_output", directory_files_mdg)])
...
file_link_nzl_glonaf = here("13.  bias assessment results", "nzl-Glonaf-native-filtered", directory_files_nzl_glonaf[grepl("assessRarityBias_output", directory_files_nzl_glonaf)])
...
# file_link_usa = here("13.  bias assessment results", "usa-native-filtered", directory_files_usa[grepl("assessRarityBias_output", directory_files_usa)])
...
file_link_zaf = here("13.  bias assessment results", "zaf-native-filtered", directory_files_zaf[grepl("assessRarityBias_output", directory_files_zaf)])
...
# grid.arrange(rarity_plot_usa , rarity_plot_gbr, ncol = 2)
grid.arrange(rarity_plot_irl, rarity_plot_jpn, ncol = 2)
grid.arrange(rarity_plot_mdg, rarity_plot_nzl_glonaf, ncol = 2)
grid.arrange(rarity_plot_aus_glonaf, rarity_plot_zaf, ncol = 2)
```
...
```{r}
rare_coverage_ranges_joined |> dplyr::group_by(region) |> dplyr::summarise(Families = length(unique(Taxonomic_Group)), average_periods = mean(n_periods, na.rm = TRUE), 
                                                                           `mean_tax_index_%` = round(mean(mean_index) * 100, 2)) |> knitr::kable()
...
# Table: Summary of the number of oversampling vs undersampling events
family_residual_joined |> dplyr::group_by(region, `Bias type`) |>
  dplyr::summarise(n_biased_families = length(unique(family)),
                   n_bias_events = length(family)
...
file_link_aus_glonaf = here("13.  bias assessment results", "aus_glonaf-native-filtered", directory_files_aus_glonaf[grepl("assessSpatialBias_output", directory_files_aus_glonaf)])
...
### Figure: Nearest neighbour index for aus_glonaf-native-filtered occurrence data
...
#file_link_gbr = here("13.  bias assessment results", "gbr-native-filtered", directory_files_gbr[grepl("assessSpatialBias_output", directory_files_gbr)])
...
### Figure: Nearest neighbour index for gbr-native-filtered occurrence data
...
file_link_irl = here("13.  bias assessment results", "irl-nir-native-filtered", directory_files_irl[grepl("assessSpatialBias_output", directory_files_irl)])
...
### Figure: Nearest neighbour index for irl-nir-native-filtered occurrence data
...
file_link_jpn = here("13.  bias assessment results", "jpn-native-filtered", directory_files_jpn[grepl("assessSpatialBias_output", directory_files_jpn)])
...
### Figure: Nearest neighbour index for jpn-native-filtered occurrence data
...
file_link_mdg = here("13.  bias assessment results", "mdg-native-filtered", directory_files_mdg[grepl("assessSpatialBias_output", directory_files_mdg)])
...
### Figure: Nearest neighbour index for mdg-native-filtered occurrence data
...
file_link_nzl_glonaf = here("13.  bias assessment results", "nzl-Glonaf-native-filtered", directory_files_nzl_glonaf[grepl("assessSpatialBias_output", directory_files_nzl_glonaf)])
...
### Figure: Nearest neighbour index for nzl-Glonaf-nativefiltered occurrence data
...
#file_link_usa = here("13.  bias assessment results", "usa-native-filtered", directory_files_usa[grepl("assessSpatialBias_output", directory_files_usa)])
...
### Figure: Nearest neighbour index for usa-native-filtered occurrence data
...
file_link_zaf = here("13.  bias assessment results", "zaf-native-filtered", directory_files_zaf[grepl("assessSpatialBias_output", directory_files_zaf)])
...
### Figure: Nearest neighbour index for zaf-native-filtered occurrence data
