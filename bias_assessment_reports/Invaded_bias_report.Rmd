...
Table 3: ANOVA p-values - Differences in the Number of species across taxonomic groups (families)
```{r, echo =FALSE, cache=TRUE, results='asis', message=FALSE, warning=FALSE}
## **(species)**
...
for (family in families_aus_glonaf) {
  ...
  family_residual_aus_glonaf[[family]] = data.frame(family = family,
                                             ...
                                             r_square = resid_fam_aus_glonaf$index,
...
family_residual_aus_glonaf2 = family_residual_aus_glonaf |> 
  ...
  dplyr::summarise(mean_residual = mean(mean_residual),
                   conf_lower = conf_lower, conf_upper = conf_upper, r_square = mean(r_square)) |>
...
for (family in families_nzl_glonaf) {
  ...
  family_residual_nzl_glonaf[[family]] = data.frame(family = family,
                                             ...
                                             r_square = resid_fam_nzl_glonaf$index,
...
### by family
directory_files_aus_glonaf = list.files(here("13.  bias assessment results", paste0(db_table, "_invaded_clean")))

file_link_aus_glonaf = here("13.  bias assessment results", paste0(db_table, "_invaded_clean"), directory_files_aus_glonaf[grepl("assessEnvBias_output", directory_files_aus_glonaf)])
file_link_aus_glonaf = file_link_aus_glonaf[!grepl("species", file_link_aus_glonaf)]
plot_data_name <- paste0(db_table, "_envBias_plot")
