...
drop_url = "https://www.dropbox.com/sh/g7hbgbfyzocizmx/AADB9UE8pXEfqZnNNmv3k-yha/JPN/JPN-native-filtered.csv?dl=1"
country = "jpn"
...
for (n in N) {
  ...
  tryCatch({
    ...
    x = dbGetQuery(aws_con, "SELECT COUNT(*) FROM jpn_native_filtered")$count
