...
drop_url = "https://www.dropbox.com/sh/g7hbgbfyzocizmx/AABMGtats8ytJVuye4w2MwKsa/MDG/MDG-native-filtered.csv?dl=1"
country = "mdg"
...
for (n in N) {
  ...
  tryCatch({
    if(!("mdg_native_filtered" %in% dbListTables(aws_con))){
      print("fetching new")
