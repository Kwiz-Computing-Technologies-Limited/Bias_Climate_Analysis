...
drop_url = "https://www.dropbox.com/sh/g7hbgbfyzocizmx/AACrVVjolnVfBHbfS1MXo7bTa/IRL/IRL-native-clean.csv?dl=1"
country = "irl"
...
for (n in N) {
  ...
  tryCatch({
    ...
    x = dbGetQuery(aws_con, "SELECT COUNT(*) FROM irl_native_clean")$count
