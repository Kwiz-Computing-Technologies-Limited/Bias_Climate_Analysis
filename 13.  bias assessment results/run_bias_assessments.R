...
occ_data = tibble(dataset = c("aus_glonaf_invaded_clean",
                  ...
                  drop_url = c("https://www.dropbox.com/s/6kkdjtvdh52s0oo/AUS-Randall-invaded-clean.csv?dl=1",
                               ...
                               "https://www.dropbox.com/s/cw2cm97mc7wnjyq/NZL-Aikio-invaded-clean.csv?dl=1",
                               "https://www.dropbox.com/s/rkb7a2rutw7vsel/NZL-Glonaf-invaded-clean.csv?dl=1",
                               "https://www.dropbox.com/s/mtqukig658nd3ov/NZL-Randall-invaded-clean.csv?dl=1",
