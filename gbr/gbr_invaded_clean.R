...
drop_url = "https://www.dropbox.com/sh/g7hbgbfyzocizmx/AAASTF8v1Eq0N_FP1QUDYuxGa/GBR/GBR-invaded-clean-v1.csv?dl=1"
country = "gbr"
...
for (n in N) {
  ...
  tryCatch({
    ...
    x = dbGetQuery(aws_con, "SELECT COUNT(*) FROM gbr_invaded_clean")$count
