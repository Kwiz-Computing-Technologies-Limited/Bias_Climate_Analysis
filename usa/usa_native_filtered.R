...
drop_url = "https://www.dropbox.com/sh/g7hbgbfyzocizmx/AACit7ZDwxFiCRBLd5KzU3RCa/USA/USA-native-filtered.csv?dl=1"
country = "usa"
...
for (n in N) {
  ...
  tryCatch({
    ...
    x = dbGetQuery(aws_con, "SELECT COUNT(*) FROM usa_native_filtered")$count
